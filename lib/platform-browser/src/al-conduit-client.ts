...
export class AlConduitClient
{
     ...
     *
     * @param insightLocationId The external location ID.  If unspecified, the associated contextual location will be used by default.
     * @returns Boolean true or false.
     */
    public checkExternalSession( insightLocationId?:string ):boolean {
        let targetLocationId = insightLocationId || this.context.locationId;
     ...
     *
     * @param insightLocationId The external location ID.  If unspecified, the contextual location will be used by default.
    ...
    public onReceiveMessage = (event: any):void => {
        ...
        const originNode = this.context.resolveNodeByURI( event.origin );
        const originWhitelist:string[] = [ AlLocation.MagmaUI, AlLocation.AccountsUI, AlLocation.LegacyUI ];
